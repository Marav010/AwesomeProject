...
export default function Card() {
    return (
        <View style={{ padding: 20 }}>
            ...
            {/* ก้อนที่2 */}
            <View>
                <Image style={{width :50, height:50,borderRadius:50/2}} source={require('../../assets/week3/trip-2.jpg')}/>
            </View>
            {/* ก้อนที่3 */}
            <View>
                <Text>Overseas Adventure Travel In Nepal</Text>
                <Text>Andaz Tokyo Toranomon Hills is one of the newest luxury hotels in Tokyo. Located in one of the uprising areas of Tokyo
</Text>
            </View>
        </View>
    );
